...
struct UHT_STATICS
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Type_MetaData[] = {
		...
		{ "Comment", "/** Cosmetic hook multicast to all relevant clients; useful for glow/audio/NPC animation. */" },
#endif
		{ "ModuleRelativePath", "Public/Game/DMFHealerActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Cosmetic hook multicast to all relevant clients; useful for glow/audio/NPC animation." },
#endif
	};
#endif // WITH_METADATA
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Server-side gameplay hook after an accepted use. */" },
#endif
		{ "ModuleRelativePath", "Public/Game/DMFHealerActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Server-side gameplay hook after an accepted use." },
#endif
	};
#endif // WITH_METADATA
...
struct UHT_STATICS
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Type_MetaData[] = {
		{ "Category", "Digimon MMO|Healer" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Lower-level API for custom systems. Normal v0.5.2 player setup uses ADMFPlayerAvatarCharacter::Interact. */" },
#endif
		{ "ModuleRelativePath", "Public/Game/DMFHealerActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Lower-level API for custom systems. Normal v0.5.2 player setup uses ADMFPlayerAvatarCharacter::Interact." },
#endif
	};
#endif // WITH_METADATA
...
// ********** End Class ADMFHealerActor constinit property declarations ****************************
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ADMFHealerActor_BP_OnHealPresentation, "BP_OnHealPresentation" }, // 1551ff5d7440e448f86d52e717191cb3caecfa13
		{ &Z_Construct_UFunction_ADMFHealerActor_BP_OnPlayerHealed, "BP_OnPlayerHealed" }, // 1c1bd34e7830d6d086e87e596489a8c0650a017c
		...
		{ &Z_Construct_UFunction_ADMFHealerActor_RequestHeal, "RequestHeal" }, // 08d664a26a05e812917e883345b568affb898c22
...
#error UHT_STATICS already defined
#endif
#define UHT_STATICS Z_CompiledInDeferFile_FID_Users_Leen_Documents_Unreal_Projects_DigimonMMO3D_Plugins_DigimonMMOFramework_Source_DigimonMMOFramework_Public_Game_DMFHealerActor_h__Script_DigimonMMOFramework_Statics
struct UHT_STATICS
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Leen_Documents_Unreal_Projects_DigimonMMO3D_Plugins_DigimonMMOFramework_Source_DigimonMMOFramework_Public_Game_DMFHealerActor_h__Script_DigimonMMOFramework_cafcf875c66666fe70ac459c9570f35a7058c94a{
