...
struct UHT_STATICS
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BitsText_MetaData[] = {
		{ "BindWidgetOptional", "" },
		{ "Category", "DMFCombatQuickBarWidget" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Optional binding for Blueprint reskins. Displays the owning account's owner-only replicated BITS balance. */" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/UI/DMFCombatQuickBarWidget.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Optional binding for Blueprint reskins. Displays the owning account's owner-only replicated BITS balance." },
#endif
	};
...
// ********** Begin Class UDMFCombatQuickBarWidget constinit property declarations *****************
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_BitsText;
...
const UECodeGen_Private::FObjectPropertyParams UHT_STATICS::NewProp_BitsText = { "BitsText", nullptr, (EPropertyFlags)0x012408000008001c, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, nullptr, nullptr, 1, STRUCT_OFFSET(UDMFCombatQuickBarWidget, BitsText), Z_Construct_UClass_UTextBlock, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BitsText_MetaData), NewProp_BitsText_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const UHT_STATICS::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&UHT_STATICS::NewProp_BitsText,
...
#error UHT_STATICS already defined
#endif
#define UHT_STATICS Z_CompiledInDeferFile_FID_Users_Leen_Documents_Unreal_Projects_Digimon_MMO_3D_Plugins_DigimonMMOFramework_Source_DigimonMMOFramework_Public_UI_DMFCombatQuickBarWidget_h__Script_DigimonMMOFramework_Statics
struct UHT_STATICS
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_UDMFCombatQuickBarWidget, TEXT("UDMFCombatQuickBarWidget"), &Z_Registration_Info_UClass_UDMFCombatQuickBarWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMFCombatQuickBarWidget), 3440425124U) },
	};
}; // UHT_STATICS 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Leen_Documents_Unreal_Projects_Digimon_MMO_3D_Plugins_DigimonMMOFramework_Source_DigimonMMOFramework_Public_UI_DMFCombatQuickBarWidget_h__Script_DigimonMMOFramework_c2735722e5656421867c05ebc256572f8fc5102a{
